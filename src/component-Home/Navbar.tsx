    ...
    <div className="container relative">
      <div className="bg-white rounded-xl sticky top-0 z-20 py-5 mt-7 shadow-md">
        <div className="container flex justify-between items-center px-6">
          ...
          <RxHamburgerMenu
            onClick={ShowOff}
            className="sm:hidden text-[22px] font-bold text-black cursor-pointer"
          />
          {/* دکمه ورود */}
          <button
            className="rounded-lg bg-blue-600 hover:bg-blue-900 whitespace-nowrap
            lg:text-[14px] py-2 px-4 text-[10px] xl:py-4 text-white font-Vazirmatn2
        ...
        {isMenuOpen && (
          <div
            className="sm:hidden bg-gray-100 rounded-lg mt-2 p-4 px-4 absolute text-center
          font-Vazirmatn3"
          >
