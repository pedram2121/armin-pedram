                    ...
                    <div className="container">
                            ...
                            <div className='flex justify-between'>
                                ...
                                <div className='space-y-6'>
                                    <div className="flex-col justify-center items-center">
                                        <div className="bg-slate-200 rounded-xl lg:w-[480px] md:w-[400px]
                     sm:w-[380px] h-40 box-border relative" >
                             ...
                             h-8 w-16 rounded-t-lg -bottom-5 left-1/2 -translate-x-1/2 -translate-y-1/2'>
                                                ...
                                                <Image className='bg-[#387CFF] absolute -bottom-3 left-1/2 -translate-x-1/2 -translate-y-1/2' src={Group3} />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className='flex-col relative space-y-5'>
                                    <div className='bg-slate-200 h-24 w-72 rounded-lg'>
                                        <div className='text-center'>
                                            ...
                                            <Image className='bg-[#387CFF] -bottom-3 ml-[120px] translate-x-1/2 -translate-y-1/2' src={Group3} />
                                        </div>
                                    </div>
