...
function BaseTwo() {
    ...
    useEffect(() => {
        ...
        const handleResize1 = () => {
            setIsSmallScreen1(window.innerWidth <= 768) // میگه بررسی کن فقط ببین اندازه صفحه بزرگه یا کوچیک
        };
    ...
    return (
        <div className=' bg-white w-full'>
            <div className='flex-row-reverse mt-28 flex
             h-screen items-center justify-between px-8 font-Vazirmatn1'>


                {!isSmallScreen1 ? (

                    <div className='container  flex-row-reverse top-0 mx-auto flex h-screen xl:max-w-[1350px]
                           items-center justify-between overflow-y-auto px-8 z-10' >
                        {/* // متن کنار مربع ها   */}
                        < div className="relative space-y-6 -top-32 ">

                            {/* عنوان */}
                            <div className="text-2xl font-Vazirmatn1 md:text-[24px] lg:text-3xl xl:text-4xl
                            ...
                            <div className="right-0 w-auto sm:w-[340px] md:w-[240px]  lg:w-[450px] text-right">
                                <span className="text-[10px] text-gray-500 font-Vazirmatn2 sm:text-[13px] md:text-[14px] lg:text-[16px] text-justify">
                                    طلای خرداد سامانه‌ای ثبت‌شده و معتبر است که امکان معامله‌ی طلا با کمترین کارمزد و بدون محدودیت در مبلغ و زمان را فراهم آورده. طلای شما به صورت فیزیکی تامین شده و همراه با فاکتور رسمی قابل تحویل است
                                </span>
                            </div>

                            {/* دکمه */}
                            <div className='relative text-right'>
                                <button className=" mt-2 rounded-lg bg-blue-600
                            ...
                            <div className='flex-col relative space-y-5 -mt-64  '>
                                ...
                                <div className='hidden md:block h-60 w-60  bg-[#F0F4F9] rounded-lg shadow-md'>
                                    <div className='flex flex-col px-6 pt-6 space-y-3'>
                                        ...
                                        <div className='self-end text-[10px] md:text-[12px]
                              lg:text-[14px]'>
                                            دریافت فیزیکی طلای 18 عیار
                                        </div>
                                        <div className='self-end text-[10px] md:text-[12px]
                              lg:text-[14px] text-right'>
                                            طلایی که از میلی می‌خرید، دارای کارمزدی شفاف و بدون اجرت، مالیات و کمیسیون فروشنده است
                                        </div>
                                        <div className='flex space-x-2'>
                                            <button className='text-[10px] md:text-[12px]
                              lg:text-[14px] mt-4 absolute right-7 text-blue-600'>
                                                خرید طلای آب شده 18 عیار
                                            </button>

                                            <div className='absolute top-[189px] hidden lg:block'>
                                                <svg className='fill-current text-blue-700' width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g id="vuesax/outline/arrow-left">
                                                        <g id="vuesax/outline/arrow-left_2">
                                                            <g id="arrow-left">
                                                                <path id="Vector" d="M16 12.75H10C9.59 12.75 9.25 12.41 9.25 12C9.25 11.59 9.59 11.25 10 11.25H16C16.41 11.25 16.75 11.59 16.75 12C16.75 12.41 16.41 12.75 16 12.75Z" />
                                                                <path id="Vector_2" d="M11.9999 15.7499C11.8099 15.7499 11.6199 15.6799 11.4699 15.5299L8.46994 12.5299C8.17994 12.2399 8.17994 11.7599 8.46994 11.4699L11.4699 8.46994C11.7599 8.17994 12.2399 8.17994 12.5299 8.46994C12.8199 8.75994 12.8199 9.23994 12.5299 9.52994L10.0599 11.9999L12.5299 14.4699C12.8199 14.7599 12.8199 15.2399 12.5299 15.5299C12.3799 15.6799 12.1899 15.7499 11.9999 15.7499Z" />
                                                            </g>
                                                        </g>
                                                    </g>
                                                </svg>
                        ...
                        text-center min-h-screen overflow-y-auto mb-20">
                        ...
                        {/* مربع ها */}
                            ...
                            <div className='flex flex-col relative space-y-5 '>
                                ...
                                <div className='md:block h-48 w-44  bg-[#F0F4F9] rounded-lg shadow-md'>
                                    <div className='flex flex-col px-6 pt-6 space-y-3'>
                                        <div className='self-end'>
                                        ...
                                        <div className='self-end text-[9px] md:text-[12px] text-right'>
                                            طلایی که از میلی می‌خرید، دارای کارمزدی شفاف و بدون اجرت، مالیات و کمیسیون فروشنده است
                                        </div>
                                        <div className='flex space-x-2'>
                                            <button className='text-[10px] mt-2 absolute left-8 text-blue-600'>
                                                خرید طلای آب شده 18 عیار
                                            </button>
