      ...
      {!isMobile ? (
        <>
          <div className=" container flex justify-between items-center">
            ...
            <div
              className="hidden mt-32 relative sm:h-[250px] sm:w-[250px] md:block md:h-[650px] 
            ...
            >
              ...
              >
                ...
                >
                  <div
                    style={{ width: 431, height: 860, position: "relative" }}
                  >
                    <div
                      style={{
                        width: 407,
                  ...
                  <div
                    style={{ width: 375, height: 812, position: "relative" }}
                  ></div>
                </div>
              </div>
            ...
            <div className="space-y-10 px-4 sm:w-[700px] md:w-[670px] text-justify">
              <div
                className=" text-white text-[16px] sm:text-[23px] md:text-[28px] 
          ...
          <div className="bg-[#061C3D] min-h-[200px] w-full flex-col justify-between items-center z-50">
            <div className="container h-full w-full flex justify-between items-center text-white mt-28 py-20">
              <div className="hidden md:block flex-col text-[14px] w-[200px] text-right text-gray-600 font-Vazirmatn2 space-y-4">
                <div
                  className="flex flex-row-reverse gap-6 w-36 h-11 rounded-md justify-center 
                ...
                >
                  ...
                  <div className="text-white">تلگرام</div>
                </div>
              ...
              <div className="flex-col text-[14px] w-[200px] text-right text-gray-600 font-Vazirmatn2 space-y-4 ">
                <div className="text-white">ارتباط بیشتر</div>
                <div>درباره ما</div>
                <div>تماس با ما</div>
              ...
              <div className="flex-col text-[14px] w-[200px] text-right text-gray-600 font-Vazirmatn2 space-y-4 ">
                <div className="text-white">دسترسی سریع</div>
                <div>مجوزها</div>
                <div>مشتریان حقوقی</div>
                <div>کارمزدها</div>
        ...
        <div className="mt-20 text-white flex-col justify-center items-center text-center overflow-hidden overflow-x-scroll">
          ...
          <div className="text-[11px] text-white font-Vazirmatn2 p-5 mt-3">
            خرید و فروش طلای آب شده یکی از انواع محبوب سرمایه‌گذاری در ایران است
            که باعث می‌شود از سرمایه خود در برابر تورم محافطت کنید و سود ببرید.
            برای خرید طلا ابشده می‌توانید به صورت حضوری به طلافروشی‌ها مراجعه
            کنید؛ اما روش خرید طلای آب شده آنلاین بسیار سریع‌تر، راحت‌تر و
            امن‌تر است
          </div>
          ...
          <div className="bg-[#061C3D] h-[410px] -mt-24 flex-col relative justify-between items-center z-[100]">
            <div className="flex gap-3 items-center text-right justify-end p-8 ">
              <h1 className="text-2xl font-Vazirmatn2  hover:text-gray-600">
                طلای خرداد
              </h1>
              <Image className="text-right" src={Icon} alt="Logo" />
            </div>
            <div className="-mt-1 font-Vazirmatn2 px-8">
              خرید و فروش طلای آب شده یکی از انواع محبوب سرمایه‌گذاری در ایران
              است که باعث می‌شود از سرمایه خود در برابر تورم محافطت کنید و سود
              ببرید. برای خرید طلا ابشده می‌توانید به صورت حضوری به طلافروشی‌ها
              مراجعه کنید؛ اما روش خرید طلای آب شده آنلاین بسیار سریع‌تر،
              راحت‌تر و امن‌تر است
            </div>
          </div>
        </div>
      )}
