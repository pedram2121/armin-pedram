    ...
    return (
        <div className='flex items-center text-center mx-auto justify-center mt-20 font-Vazirmatn2 text-white'>
            ...
            <div className='bg-blue-500 flex-col  text-2xl h-[800px] w-[620px] p-4 rounded-2xl rounded-l-none relative'>
                ...
                <div className='absolute sm:block sm:text-[15px] md:text-[20px]
                right-6 top-12
                 lg:text-[25px] xl:right-32 xl:top-28'>
                    تماس با ما
                </div>

                {/* دایره های زیر هم و عکس های داخل شان */}
                <div className='flex-col  xl:text-[17px] flex-wrap '>

                    <div>
                        <div className='bg-gray-300 flex items-center justify-center text-center 
                         rounded-full xl:w-20 xl:h-20 absolute xl:right-32 xl:top-48 opacity-20
                         top-[220px] right-4 w-16 h-16'>
                        </div>
                        <Image className='absolute xl:right-[152px] xl:top-[215px]  top-[235px] right-8 ' src={Envelope} alt='Envelope' />
                        <div className='absolute xl:text-[17px] xl:right-[235px] xl:top-[200px]
                         text-gray-200  top-[225px] right-24 text-[18px]'>
                            ایمیل
                        </div>
                        <div className='absolute lg:text-[17px] lg:right-[235px] lg:top-[200px]
                         text-gray-200  top-[255px] right-24 text-[16px]'>
                            info@TJMKK.com
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='bg-gray-300 flex items-center justify-center text-center 
                         rounded-full xl:w-20 xl:h-20 absolute xl:right-32 xl:top-80 opacity-20
                         top-[320px] right-4 w-16 h-16'>
                        </div>
                        <Image className='absolute xl:right-[152px] xl:top-[345px]  top-[335px] right-8 ' src={PhoneCall} alt='Envelope' />
                        <div className='absolute xl:text-[17px] xl:right-[235px] xl:top-[330px]
                         text-gray-200  top-[325px] right-24 text-[18px]'>
                            شماره تماس
                        </div>
                        <div className='absolute xl:text-[17px] xl:right-[235px] xl:top-[365px]
                         text-gray-200  top-[355px] right-24 text-[16px]'>
                            021-91200150
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='bg-gray-300 flex items-center justify-center text-center 
                         rounded-full xl:w-20 xl:h-20 absolute xl:right-32 xl:top-[450px] opacity-20
                         top-[420px] right-4 w-16 h-16'>
                        </div>
                        <Image className='absolute xl:right-[152px] xl:top-[472px]  top-[435px] right-8 ' src={MapPinLine} alt='Envelope' />
                        <div className='absolute xl:text-[17px] xl:right-[235px] xl:top-[460px]
                         text-gray-200  top-[425px] right-24 text-[18px]'>
                            بلوار نلسون ماندلا، نرسیده به چهارراه جهان کودک
                        </div>
                        <div className='absolute xl:text-[17px] xl:right-[235px] xl:top-[495px]
                         text-gray-200  top-[520px] right-24 text-[16px]'>
                ...
                <div className='flex'>
                    <div className='absolute hidden lg:block lg:right-[150px] lg:top-[650px]'>
                    ...
                    <div className='absolute xl:text-[17px] xl:right-[199px] xl:top-[635px]
                     text-[12px] whitespace-nowrap top-[650px] right-8 '>
                        ما را در شبکه های اجتماعی دنبال کنید
                    </div>
                </div>

                <div className='flex space-x-5 absolute top-[705px] right-12 xl:top-[705px] xl:right-40 xl:flex xl:text-[17px]'>
